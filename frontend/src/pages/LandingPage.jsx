        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-10 md:py-14">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              <div key={v.title} className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex items-start gap-4 hover:-translate-y-0.5 hover:shadow-md transition-all duration-200">
                <div className="w-11 h-11 rounded-xl flex items-center justify-center shrink-0" style={{ background: v.bg }}>
                  <v.icon size={20} color={v.accent} />
                </div>
                <div>
                  <div className="font-semibold text-slate-900 text-sm">{v.title}</div>
                  <div className="text-sm text-slate-500 mt-0.5">{v.desc}</div>
                </div>
              </div>
            ))}
          </div>
